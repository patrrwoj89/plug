...
// Polish Media Hub QuickJS plugin: Ekino-TV.pl
// Auto-generated from plugin-template.js — do not edit by hand.

var BASE = 'https://ekino-tv.pl';
var UA = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36';
var PROVIDER = 'ekino';
var TAG = '[ekino]';

var HOST_REGEX = 'cda\.pl|vider|streamtape|dood|vk\.com|ok\.ru|upstream|mixdrop|voe|filemoon|lulu';
var SERIES_PATHS_RE = /\/(serial|tv|film|movie)\//i;
var DATA_SRC = false;
var IFRAME_DATA_SRC = false;

var CANDIDATE_FILTER = function(href) {
      return /\/(watch|film|serial|movie)\//i.test(href);
    };
var TYPE_FROM_HREF = function(href) {
      return /\/(serial|tv)\//i.test(href) ? 'SERIES' : 'MOVIE';
    };
var EPISODE_EXTRA = function(href, text, ep){ return false; };

function search(query) {
  if (!query) return [];
  var want = normalize(query);
  try {
    var searchUrl = BASE + '/search/qf/?q=' + encodeURIComponent(query);
