...
import com.tvhub.skeleton.ui.viewmodel.LibraryViewModel
...
fun LibraryScreen(
    ...
    LazyColumn(
        ...
        item { Text(stringResource(id = R.string.library), style = AppTypography.headline, modifier = Modifier.padding(bottom = Spacing.md)) }
